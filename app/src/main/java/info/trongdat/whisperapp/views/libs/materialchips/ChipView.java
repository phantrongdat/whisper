...
public class ChipView extends RelativeLayout {
    ...
    // xml elements
    @InjectView(R.id.content) LinearLayout mContentLayout;
    @InjectView(R.id.icon)
    CircleImageView mAvatarIconImageView;
    @InjectView(R.id.label) TextView mLabelTextView;
    @InjectView(R.id.delete_button) ImageButton mDeleteButton;
    // attributes
    ...
    public void setHasAvatarIcon(boolean hasAvatarIcon) {
        ...
        if(!mHasAvatarIcon) {
            ...
            if(mAvatarIconUri != null)
                Picasso.with(mContext).load(mAvatarIconUri).placeholder(R.drawable.app_icon).into(mAvatarIconImageView);
