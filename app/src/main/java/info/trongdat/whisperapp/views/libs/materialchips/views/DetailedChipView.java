...
public class DetailedChipView extends RelativeLayout {
    ...
    // xml elements
    @InjectView(R.id.content) RelativeLayout mContentLayout;
    @InjectView(R.id.avatar_icon) CircleImageView mAvatarIconImageView;
    @InjectView(R.id.name) TextView mNameTextView;
    @InjectView(R.id.info) TextView mInfoTextView;
    ...
    public void setAvatarIcon(Uri icon) {
        Picasso.with(mContext).load(icon).placeholder(R.drawable.app_icon).into(mAvatarIconImageView);
