package info.trongdat.whisperapp.views.libs.materialchips;
...
import info.trongdat.whisperapp.views.libs.materialchips.adapter.ChipsAdapter;
...
import info.trongdat.whisperapp.views.libs.materialchips.util.ActivityUtil;
import info.trongdat.whisperapp.views.libs.materialchips.util.MyWindowCallback;
import info.trongdat.whisperapp.views.libs.materialchips.util.ViewUtil;
import info.trongdat.whisperapp.views.libs.materialchips.views.ChipsInputEditText;
import info.trongdat.whisperapp.views.libs.materialchips.views.DetailedChipView;
import info.trongdat.whisperapp.views.libs.materialchips.views.FilterableListView;
import info.trongdat.whisperapp.views.libs.materialchips.views.ScrollViewMaxHeight;
...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    // xml element
    @InjectView(R.id.chips_recycler) RecyclerView mRecyclerView;
    // adapter
